        ...
        try:
            ...
            for i, row in enumerate(rows):
                try:
                    ...
                    print("Successfully processed row")
            ...
            try:
                ...
                if next_button and "fdivGe" in next_button.get_attribute("class"):
                    ...
                    if wait_for_table_update(driver, first_player):
                        ...
                        # No need to go back to first page since we have all data
                    else:
...
def get_total_pages(driver):
    """Get total pages by clicking through Next until disabled"""
    total_pages = 1
    ...
    while True:
        ...
        if total_pages > 10:  # Safety limit
...
def scrape_all_salaries():
    ...
    try:
        ...
        chromedriver_path = r"C:\BUILD\chromedriver-win64\chromedriver.exe"
        
        options = webdriver.ChromeOptions()
        # Enable headless mode (new version)
